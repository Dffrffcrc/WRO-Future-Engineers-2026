...
This repository contains engineering materials of SSTtechnitum's self-driven vehicle model that is competing in the WRO Future Engineers competition in the 2025 season.
...
* Software
   ...
   - Ensure the MaixCam is configured and detected correctly before the run
* Hardware
